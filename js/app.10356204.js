    ...
    0: function (A, e, t) {
        ...
        var a = {
            ...
            w = function () {
                ...
                quest: "Válassza ki a kívánt színt",
                isPicInAnswers: !0,
                answers: ["quest-1-1.jpg", "quest-1-2.jpg", "quest-1-3.jpg", "quest-1-4.jpg"]
            }, {
                quest: "Válassza ki kedvenc zenei műfaját az alábbiak közül:",
                answers: ["Pop", "Rock", "Hip-Hop / Rap", "Tánc / Elektronikus / House"]
            }, {
                quest: "Válassza ki kedvenc gyümölcsét az alábbiak közül:",
                isPicInAnswers: !0,
                answers: ["quest-10-1.jpg", "quest-10-2.jpg", "quest-10.jpg", "quest-11-1.png"]
            }, {
                quest: "Válassza ki kedvenc filmműfaját az alábbiak közül:",
                answers: ["Tudományos-fantasztikus", "Vígjátékok", "Horror / Thriller", "Dokumentumfilmek / Történelmi filmek"]
            }, {
                quest: "Válassza ki a legjobban tetsző figurát",
                isPicInAnswers: !0,
                answers: ["quest-11-2.png", "quest-11-3.png", "quest-11.png", "quest-12-1.png"]
            }, {
                quest: "Ön szerint mi az, ami itt felesleges?",
                isPicInAnswers: !0,
                answers: ["quest-32.png", "quest-30-1.png", "quest-32-3.png", "quest-35-3.png"]
            }, {
                quest: "Milyen közlekedési módot részesít előnyben?",
                isPicInAnswers: !0,
                answers: ["quest-14-3.png", "quest-33.png", "quest-27-3.png", "quest-35.png"]
            }, {
                quest: "Mennyi pénzre van szüksége havonta a kényelmes élethez?",
                answers: ["Kevesebb mint 350К HUF", "350K Ft-tól 850K Ft-ig", "850K Ft-tól 1,5КK Ft-ig", "1.5KК Ft-tól"]
            }, {
                quest: "Hol szeretsz pihenni?",
                answers: ["quest-33-3.png", "quest-29.png", "quest-32-2.png", "quest-31.png"],
                isPicInAnswers: !0
            }, {
                quest: "Melyik háziállatot részesíted előnyben?",
                ...
                comments: [{avatar: "1.jpg", login: "NAta", likes: 32, time: "", text: "Az IQ-m 78 😐"}, {
                    avatar: "2.jpg",
                    login: "toster-baster",
                    likes: 11,
                    time: "",
                    ...
                    likes: 2,
                    time: "",
                    text: "Az IQ-m 89, a Mensa tesztem pedig 77"
                }, {
                    avatar: "4.jpg",
                    login: "_mila",
                    likes: 49,
                    time: "",
                    text: "Nekem 98-as az IQ-m, a húgomnak pedig 114-es🥺"
                }, {avatar: "5.jpg", login: "kailoWest", likes: 21, time: "", text: "123😊"}, {
                    avatar: "6.jpg",
                    login: "Alikz",
                    likes: 32,
                    time: "",
                    text: "Két perc alatt átmentem a teszten, jól vagyok, IQ 119 😎"
                }, {
                    avatar: "7.jpg",
                    login: "Chica Bomb",
                    likes: 112,
                    time: "",
                    text: "Szórakoztató teszt, nem is számítottam ennyi pontot szerezni (P.S. 145) :)"
                }, {
                    avatar: "8.jpg",
                    login: "trasher",
                    likes: 7,
                    time: "",
                    text: "Nem igazságos, nagyon élveztem a kérdéseket, azt hittem, magas pontszámot kapok. Átlag alatt volt. Több könyvet kellene olvasnom."
                ...
                title: "Gratulálunk!",
                messageBlock: "Minden kérdésre válaszoltál.",
                beat: "GKész!",
                calculates: [{
                    text: "A helyes válaszok számának számolása...",
                    done: !1
                }, {text: "A válaszadási idő kiszámítása...", done: !1}]
            };
        const N = n(I);
        var z = {
            data() {
            ...
            title: "Küldjön SMS-t, és megtudja az eredményt",
            underlineText: "L'information est confidentielle",
            resultMessage: "Kattintson az alábbi gombra, és azonnal küldjön SMS-t, hogy megkapja az eredményt.",
            timerText: "Várjuk válaszát:",
            ...
            props: ["clickId", "checkDevice", "iqCode"], components: {Comments: BA}, data() {
                ...
                sendClick() {
                    ...
                    let A = "";
                    return A = this.clickId ? "IQ " + " " + this.clickId + " Szeretnék megtudni az IQ-mat" : "IQ " + this.iqCode + "Szeretnék megtudni az IQ-mat", A
                }
            }, computed: {
                smsBuilder() {
                    var A;
                    ...
                    return "Desktop" === this.checkDevice ? `Szeretnék megtudni az IQ-mat` : "Szeretnék megtudni az IQ-mat"
                }, isSmallPhone() {
                    return window.innerHeight <= 667
                }, smsTo() {
                    let A = ["0690985780", "0690985781", "0690985782", "0690985783", "0690985784", "0690985785", "0690985786", "0690985787", "0690985788", "0690985789"];
                    return A[Math.floor(10 * Math.random())]
                }
            }, mounted() {
                this.startTimeout()
            }
